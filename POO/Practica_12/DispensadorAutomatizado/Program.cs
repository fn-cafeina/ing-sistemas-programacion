/*
    ...
    // Estructura guia para el estudiante
    public abstract class Producto { ... }
    public class Medicamento : Producto { ... }

    // El corazon del ejercicio: Restriccion de tipo
    public class Dispensador<T> where T : Producto
    {
        public void Despachar(T elemento) { ... }
    }
*/
